document.addEventListener("DOMContentLoaded", () => {
    ...
    sliders.forEach((slider) => {
      ...
      // Ensure images are responsive and cover their container
      items.forEach((item) => {
      ...
      // Apply image handling to all images in the slider
      items.forEach((item) => {
        const img = item.querySelector("img")
        if (img) {
          if (img.complete) {
      ...
      dropdowns.forEach((dropdown) => {
        ...
        dropdownToggle.addEventListener("touchstart", (e) => {
          ...
          dropdownToggle.setAttribute(
            "aria-expanded",
            dropdown.querySelector(".dropdown-content").classList.contains("visible"),
          )
        })
      })
    }
